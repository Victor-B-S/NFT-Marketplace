    ...
    <>
      <div className={classes.hiwContainer}>
        ...
        <div className={classes.hiwFlex}>
          <CardHowItWorks image={imageCreate} title={"Setup Your Wallet"} description={"Set up your wallet of choice. Connect it to the Animarket by clicking the wallet icon in the top right corner."} />
          <CardHowItWorks image={imageSetup} title={"Create Collection"} description={"Upload your work and setup your collection. Add a description, social links and floor price."} />
